...
options = '-m /usr/share/hts-voice/mei/mei_happy.htsvoice -ow /tmp/dialogue/out.wav -x /var/lib/mecab/dic/open-jtalk/naist-jdic'
...
if __name__ == '__main__':
    ...
    answer = str(reply['質問'])
    choices = str(reply['選択肢'])

    print("Silly: " + answer)
    print("どうしようか・・・・ :" + choices)

    # print("(´｡•ㅅ•｡`)　: " + answer)

#ここでgoodword,badword,normalword処理
